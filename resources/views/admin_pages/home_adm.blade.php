...
<div class="text-center">
    <a href="{{ url('admin/events') }}"  type="button" class="btn btn-primary btn-lg btn-block">Eventos</a>
    <a href="{{ url('admin/proveedores') }}"  type="button" class="btn btn-primary btn-lg btn-block">proveedores</a>
